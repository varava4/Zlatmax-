(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".product-new__slider")) new swiper_core_Swiper(".product-new__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            watchOverflow: true,
        ...
        if (document.querySelector(".images-product__thumb")) {
            const thumbsSwiper = new swiper_core_Swiper(".images-product__thumb", {
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest("[data-parent]")) {
            ...
            } else console.log("Ой ой, нема такого подменю :(");
            e.preventDefault();
        }
